            ...
            with gr.Column():
                ...
                with gr.Row():
                    shared.gradio["mode"] = gr.Radio(
                        ...
                        if shared.settings["mode"] in ["chat", "chat-instruct"]
                        else None,
                        label="Mode",
    ...
    with gr.Tab("Chat"):
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                shared.gradio["character_background_picture"] = gr.Image(
                    label="background picture", type="pil", interactive=not mu
                )
...
def create_event_handlers():
    ...
    shared.gradio["Replace last reply"].click(
        ...
        chat.handle_replace_last_reply_click,
    ...
    shared.gradio["delete_chat-confirm"].click(
        ...
        gradio("interface_state"),
        gradio("history", "display", "unique_id") + gradio(clear_arr),
        show_progress=False,
    )
    ...
    shared.gradio["rename_to-confirm"].click(
        ...
        gradio("unique_id", "rename_to", "rename_to-confirm", "rename_to-cancel"),
        show_progress=False,
    )
    ...
    shared.gradio["mode"].change(
        ...
        gradio("mode"),
        None,
        js="(mode) => {mode === 'instruct' ? document.getElementById('character-menu').parentNode.parentNode.style.display = 'none' : document.getElementById('character-menu').parentNode.parentNode.style.display = ''}",
    )
    ...
    shared.gradio["send_instruction_to_negative_prompt"].click(
        ...
        None,
        None,
        js=f"() => {{{ui.switch_tabs_js}; switch_to_generation_parameters()}}",
    )
