    ...
    with gr.Tab('Chat'):
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                shared.gradio['character_background_picture'] = gr.Image(label='background picture', type='pil', interactive=not mu)
...
def create_event_handlers():
    ...
    shared.gradio['character_menu'].change(
        ui.gather_interface_values, gradio(shared.input_elements), gradio('interface_state')).then(
        chat.handle_character_menu_change, gradio('interface_state'), gradio('history', 'display', 'name1', 'name2', 'character_picture', 'character_background_picture','greeting', 'context', 'unique_id'), show_progress=False).then(
